...
/*THE BITVECTOR IS AN ARRAY DATA STRUCTURE THAT STORES BITS
  THIS IS USED TO COMPACTLY STORE INFORMATION SO THAT NO SPACE IS WASTED.
  ALSO OPERATIONS CAN BE PERFORMED ON BIT ARRAYS SO THAT THEY ARE  PERFORMED
  QUICKLY.

  WHENEVER WE TALK ABOUT BITVECTOR WE TALK ABOUT BIT MANIPULATION AT SYSTEM
  LEVEL AND NOT BYTE
